  ...
  return (
    <CommonMenuWrapper>
      <CommonMenuContainer>
        ...
        <MenuList>
          <Menu onClick={() => handleRouter("/admin/user")} active={pathName === "/admin/user"}>
            유저
          </Menu>
          <Menu onClick={() => handleRouter("/admin/pray")} active={pathName === "/admin/pray"}>
            기도제목
          </Menu>
          <Menu onClick={() => handleRouter("/admin/advice")} active={pathName === "/admin/advice"}>
            성경AI
          </Menu>
        </MenuList>
      </CommonMenuContainer>
